...
class Foo(object):
 ...
 def demiurgic_mystificator(self, dactyl):inception = a.palpitation(dactyl);demarcation = b.dark_voodoo(inception);return demarcation
 def test(self, whatever):print(whatever)
if __name__ == '__main__':print('Forming...');f = Foo('epicaricacy', 'perseverate');f.test('Codswallop')